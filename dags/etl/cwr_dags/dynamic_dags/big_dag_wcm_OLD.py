...
from etl.common_packages.functions import ecs_parser_two_steps, emr_parser, check_running
...
with DAG(
    ...
    get_ecs_configs >> step1_run_fargate >> check_running >> steps_running_STOP
    (get_ecs_configs >> step1_run_fargate >> check_running >> nothing_running_continue
     >> get_emr_configs
     >> step2_start_EMR
     >> add_steps
     >> copy_lookup_tables
