"""
DDEX Preprocessing (copy files from DotBc into the env)
...
from etl.common_packages.functions import slack_failed, slack_info, ecs_parser_ddex_prepro
...
with DAG(
    ...
    params = AWSDagParams(ENVIRONMENT, execution_type='ddex_prepro')
    ...
    get_ecs_configs = PythonOperator(
        ...
        python_callable=ecs_parser_ddex_prepro,
